...
const SendChatMsg = ({ roomId,  type, users }) => {
  ...
  }, [socket]);  // socket이 변경될 때마다 이벤트를 등록하도록 의존성 배열 추가
  ...
  return (
    <div className="border h-screen flex flex-col max-w-lg mx-auto" style={{height : "100vh"}}>
      <div class="bg-blue-500 p-4 text-white flex justify-between items-center">
        <span><b>{users.join(', ')}</b></span>
      </div>
                ...
                {/*{room === roomId && (
                  chatUserName === userName ? (
                    ...
                    <div  className="mb-4">
                        ...
                        <div className="flex">
                            <div className="text-black">
                                <p className="text-xs"> {chatUserName}</p>
                                <div className="bg-gray-300 text-black p-2 rounded-lg max-w-xs">
                                    {msg}
                                </div>
                            </div>
